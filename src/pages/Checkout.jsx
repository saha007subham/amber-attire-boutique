  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const GOOGLE_SCRIPT_WEBHOOK_URL =
        "https://script.google.com/macros/s/AKfycby105A-lVEjbNe2uW0orGdLXHL0G2-6PGTwVDSNbaIGvWhEuWLfK2tzWY_IiI1Pnj8-PQ/exec";
      ...
      <form className="checkout-grid" onSubmit={handleSubmit}>
        ...
        <div className="checkout-section">
          ...
          <div className="delivery-options">
            <label
              className={`delivery-card ${deliveryOption === "standard" ? "active" : ""}`}
            >
            ...
            <label
              className={`delivery-card ${deliveryOption === "express" ? "active" : ""}`}
            >
              <div className="delivery-info">
                <input
                  type="radio"
        ...
        <div className="checkout-section summary-section">
          ...
          <div className="payment-options">
            ...
            <label
              className={`payment-card ${paymentOption === "cash" ? "active" : ""}`}
            >
              <input
                type="radio"
                name="payment"
            ...
            <label
              className={`payment-card ${paymentOption === "upi" ? "active" : ""}`}
            >
              <input
                type="radio"
                name="payment"
      ...
      {showSuccessModal && (
        <div className="order-success-overlay">
          <div className="order-success-modal">
            ...
            <p>
              Thank you for shopping with Amber Attiire.
              <br />
              Your order has been received and our team will contact you
              shortly.
            </p>
